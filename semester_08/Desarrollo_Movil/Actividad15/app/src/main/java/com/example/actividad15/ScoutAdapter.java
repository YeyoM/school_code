...
public class ScoutAdapter extends
        RecyclerView.Adapter<ScoutAdapter.ScoutHolder> {
    ...
    @NonNull
    @Override
    public ScoutHolder onCreateViewHolder(@NonNull ViewGroup parent, int
            viewType) {
        View view =
    ...
    public class ScoutHolder extends RecyclerView.ViewHolder {
        ...
        public void setDetails(Scout scout) {
            ...
            txtKill.setText(String.format("kill: %s",
                    scout.getKillCount()));
        }
    }
}
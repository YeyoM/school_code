...
/* Seeding the random number generator with the process ID of the program. */
    ...
    // create an array to save the number of 0's in the string
    int ceros[11];

    // create a copy of the generation
    string binariosCopy[100][100];

    //aqui imprimo la primera generacion
    for(int i=1;i<=10;i++)
    {
      binariosCopy[1][i] = binarios[1][i];
      // ir guardando el numero de 0's en el array
      ceros[i] = countOccurrences(ch1,binarios[1][i]);
    }
    // ordenandingggggg jajajaj...
    for (int i = 1; i <= 10; i++) {
      int max_ceros = largest(ceros, 11);
      // get index of that max_ceros
      int index = 0;
      for (int j = 1; j <= 10; j++) {
      ...
      binarios[1][i] = binariosCopy[1][index];
      ceros[index] = -1;
    }
    for(int i=1;i<=10;i++) {
      cout<<i<<":"<<binarios[1][i]<<":";
    ...
    for(int i=1;i<11;i++) {
      ...
      binariosCopy[2][i] = binarios[2][i];
      // ir guardando el numero de 0's en el array
      ceros[i] = countOccurrences(ch1,binarios[2][i]);
    }
    for (int i = 1; i <= 10; i++) {
      int max_ceros = largest(ceros, 11);
      // get index of that max_ceros
      ...
      binarios[2][i] = binariosCopy[2][index];
      ceros[index] = -1;
    }
    for(int i=1;i<=10;i++) {
      cout<<i<<":"<<binarios[2][i]<<":";
	...
	for(int i=1;i<11;i++)
	{
		...
		if(countOccurrences(ch1, binarios[1][i])<countOccurrences(ch1, binarios[2][i]))
		{
		  ...
		  binariosCopy[3][i] = binarios[3][i];
      // ir guardando el numero de 0's en el array
      ceros[i] = countOccurrences(ch1,binarios[3][i]);
	}
      for (int i = 1; i <= 10; i++) {
      int max_ceros = largest(ceros, 11);
      // get index of that max_ceros
      ...
      binarios[3][i] = binariosCopy[3][index];
      ceros[index] = -1;
    }
    for(int i=1;i<=10;i++) {
      cout<<i<<":"<<binarios[3][i]<<":";
...
//hayq que hacer que sea recursivo y que no tenga tanta puta linea
    ...
    for(int i=1;i<11;i++)
    {
      ...
      binariosCopy[4][i] = binarios[4][i];
      // ir guardando el numero de 0's en el array
      ceros[i] = countOccurrences(ch1,binarios[4][i]);
    }
        for (int i = 1; i <= 10; i++) {
      int max_ceros = largest(ceros, 11);
      // get index of that max_ceros
      ...
      binarios[4][i] = binariosCopy[4][index];
      ceros[index] = -1;
    }
    for(int i=1;i<=10;i++) {
      cout<<i<<":"<<binarios[4][i]<<":";
	...
	for(int i=1;i<11;i++)
	{
		...
		if(countOccurrences(ch1, binarios[4][i])<countOccurrences(ch1, binarios[3][i]))
		{
			...
			binarios[5][i]=binarios[4][i];
		      ...
		      binariosCopy[5][i] = binarios[5][i];
      // ir guardando el numero de 0's en el array
      ceros[i] = countOccurrences(ch1,binarios[5][i]);
	}
      for (int i = 1; i <= 10; i++) {
      int max_ceros = largest(ceros, 11);
      // get index of that max_ceros
      ...
      binarios[5][i] = binariosCopy[5][index];
      ceros[index] = -1;
    }
    for(int i=1;i<=10;i++) {
      cout<<i<<":"<<binarios[5][i]<<":";
    ...
    for(int i=1;i<11;i++)
    {
        ...
        binarios[6][i]=binarios[5][i].substr(0,num6)+binarios[5][11-i].substr(num6,9);
              binariosCopy[6][i] = binarios[6][i];
      // ir guardando el numero de 0's en el array
      ceros[i] = countOccurrences(ch1,binarios[6][i]);
    }
        for (int i = 1; i <= 10; i++) {
      int max_ceros = largest(ceros, 11);
      // get index of that max_ceros
      ...
      binarios[6][i] = binariosCopy[6][index];
      ceros[index] = -1;
    }
    for(int i=1;i<=10;i++) {
      cout<<i<<":"<<binarios[6][i]<<":";
	...
	for(int i=1;i<11;i++)
	{
		...
		if(countOccurrences(ch1, binarios[6][i])<countOccurrences(ch1, binarios[5][i]))
		{
			...
			binarios[7][i]=binarios[6][i];
		      ...
		      binariosCopy[7][i] = binarios[7][i];
      // ir guardando el numero de 0's en el array
      ceros[i] = countOccurrences(ch1,binarios[7][i]);
	}
      for (int i = 1; i <= 10; i++) {
      int max_ceros = largest(ceros, 11);
      // get index of that max_ceros
      ...
      binarios[7][i] = binariosCopy[7][index];
      ceros[index] = -1;
    }
    for(int i=1;i<=10;i++) {
      cout<<i<<":"<<binarios[7][i]<<":";
    ...
    for(int i=1;i<11;i++)
    {
        ...
        binarios[8][i]=binarios[7][i].substr(0,num8)+binarios[7][11-i].substr(num8,9);
              binariosCopy[8][i] = binarios[8][i];
      // ir guardando el numero de 0's en el array
      ceros[i] = countOccurrences(ch1,binarios[8][i]);
    }
        for (int i = 1; i <= 10; i++) {
      int max_ceros = largest(ceros, 11);
      // get index of that max_ceros
      ...
      binarios[8][i] = binariosCopy[8][index];
      ceros[index] = -1;
    }
    for(int i=1;i<=10;i++) {
      cout<<i<<":"<<binarios[8][i]<<":";
	...
	for(int i=1;i<11;i++)
	{
		...
		if(countOccurrences(ch1, binarios[8][i])<countOccurrences(ch1, binarios[7][i]))
		{
			...
			binarios[9][i]=binarios[8][i];
		      ...
		      binariosCopy[9][i] = binarios[9][i];
      // ir guardando el numero de 0's en el array
      ceros[i] = countOccurrences(ch1,binarios[9][i]);
	}
      for (int i = 1; i <= 10; i++) {
      int max_ceros = largest(ceros, 11);
      // get index of that max_ceros
      ...
      binarios[9][i] = binariosCopy[9][index];
      ceros[index] = -1;
    }
    for(int i=1;i<=10;i++) {
      cout<<i<<":"<<binarios[9][i]<<":";

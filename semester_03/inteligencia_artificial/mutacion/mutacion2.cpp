...
int main() {
  ...
  for (int k = 0; k < NUMERO_DE_CADENAS / 2; k++) {
    ...
    if (k == 0) {
      ...
      for (int i = 0; i < 6; i++) {
        int cerosA = 0;
        cerosA = countOccurrences(auxiliar, binarios1[k-1][indicesAleatorios[i]]);
        if (cerosA == 10) {
  ...
  for (int k = 0; k < NUMERO_DE_CADENAS / 2; k++) {
    ...
    if (k == 0) {
      ...
      for (int i = 0; i < 6; i++) {
        int cerosB = 0;
        cerosB = countOccurrences(auxiliar, binarios1[NUMERO_DE_CADENAS / 2 - 1][indicesAleatorios[i]]);
        if (cerosB == 10) {
      ...
      for (int i = 0; i < 6; i++) {
        int cerosC = 0;
        cerosC = countOccurrences(auxiliar, binarios2[k-1][indicesAleatorios[i]]);
        if (cerosC == 10) {
          binarios2[k][i] = binarios2[k-1][i];
        } else {
          int num2 = 1 + rand() % (10 - 1);
    ...
    for (int i = 0; i < 10; i++) {
      binarios2[k][i] = binariosCopy2[k][i];
    }
